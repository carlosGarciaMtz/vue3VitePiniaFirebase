...
$(document).ready(function () {
    ...
    $("#sendCall").callMe({"fSendCallBack":fSendCallMeNew,"textNumber":$("#flex_landingccflex1_telefono"),"formCall":$("#flex_landingccflex1_form")});
    $("#sendCall2").callMe({"fSendCallBack":fSendCallMeNew,"textNumber":$("#flex_landingccflex2_telefono"),"formCall":$("#flex_landingccflex2_form")});
